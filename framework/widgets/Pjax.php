...
/**
 * Pjax is a widget integrating the [pjax](https://github.com/framework/jquery-pjax) jQuery plugin.
 *
...
class Pjax extends Widget
{
     ...
     * [pjax project page](https://github.com/framework/jquery-pjax) for available options.
     */
